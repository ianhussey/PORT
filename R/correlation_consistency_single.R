#' correlation_consistency_single
#'
...
#' @examples
#' \dontrun{
#' correlation_consistency_single(r_XY = .70, r_XZ = .80, r_YZ = .10)
#' 
#' correlation_consistency_single(r_XY = .90, r_XZ = .90, r_YZ = .10)
#' 
#' correlation_consistency_single(r_XY = .50, r_XZ = .40, r_YZ = .20)
#' }
#' @export
correlation_consistency_single <- function(r_XY, r_XZ, r_YZ = NA){
  require(janitor)
  require(dplyr)
